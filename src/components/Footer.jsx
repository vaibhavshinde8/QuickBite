      ...
      <>
        <footer>
          <div className="sec1">
            ...
            <div className="main-footer">
              ...
              <div className="foot3">
                ...
                <div className="foot3-2">
                  ...
                  <nav>
                    <a href="#"><p>Quickbite For Enterprise</p></a>
                  </nav>
                </div>
              </div>
              <div className="foot4">
              ...
              <div className="foot5">
                <h6>SOCIAL LINKS</h6>
                <div className="icons">
                  <a target="_blank" ><i className="fa-brands fa-linkedin" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" ><i className="fa-brands fa-instagram" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" ><i className="fa-brands fa-twitter" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" ><i className="fa-brands fa-youtube" style={{ color: '#000000' }}></i></a>
                  <a target="_blank"><i className="fa-brands fa-facebook" style={{ color: '#000000' }}></i></a>
                </div>
            ...
            <hr className="h-line" />
            <p className="copyright">By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy, and Content Policies. All trademarks are properties of their respective owners. 2008-2023 © Quickbite Ltd. All rights reserved.</p>
          </div>
        </footer>
      </>
    );
